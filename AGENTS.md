...
NEVER finish your turn or declare a task complete without logging the history entry and recording any new learnings as detailed multi-sentence entries (3-4 sentences minimum):
```bash
